import { n as __commonJSMin, t as require_react } from "./react-Fa_Rp67L.js";
import { t as require_react_dom } from "./react-dom-z_TU5R-m.js";
...
var currentImports$1 = {};
var moduleMap = {
	"react": {
		get: () => () => __federation_import$1(new URL("__federation_shared_react-CAxElwLl.js", import.meta.url).href),
		import: true
	},
	"react-dom": {
		get: () => () => __federation_import$1(new URL("__federation_shared_react-dom-PQfWajFT.js", import.meta.url).href),
		import: true
	}
};
...
async function __federation_import$1(name) {
	currentImports$1[name] ??= __vitePreload(() => import(name), []);
...
function get(name, remoteFrom) {
	return __federation_import(name).then((module) => () => {
		if (remoteFrom === "webpack") return Object.prototype.toString.call(module).indexOf("Module") > -1 && module.default ? module.default : module;
		return module;
	});
}
function merge(obj1, obj2) {
	const mergedObj = Object.assign(obj1, obj2);
	for (const key of Object.keys(mergedObj)) if (typeof mergedObj[key] === "object" && typeof obj2[key] === "object") mergedObj[key] = merge(mergedObj[key], obj2[key]);
	return mergedObj;
}
var wrapShareModule = (remoteFrom) => {
	return merge({
		"react": { "19.2.4": {
			get: () => get(new URL("__federation_shared_react-CAxElwLl.js", import.meta.url).href, remoteFrom),
			loaded: 1
		} },
		"react-dom": { "19.2.4": {
			get: () => get(new URL("__federation_shared_react-dom-PQfWajFT.js", import.meta.url).href, remoteFrom),
			loaded: 1
		} }
...
async function __federation_method_ensure(remoteId) {
	...
	if (!remote.inited) {
		if ("var" === remote.format) return new Promise((resolve) => {
			const callback = () => {
				if (!remote.inited) {
		...
		else if (["esm", "systemjs"].includes(remote.format)) return new Promise((resolve, reject) => {
			(typeof remote.url === "function" ? remote.url : () => Promise.resolve(remote.url))().then((url) => {
...
var { lazy, Suspense } = await importShared("react");
var RemoteChat = lazy(() => __federation_method_getRemote("chatRemote", "./ChatWidget").then((module) => __federation_method_wrapDefault(module, true)).catch((err) => {
	console.error("Self-Healing: Chat load failed!", err);
	return { default: () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		style: {
			color: "red",
			border: "1px solid red",
			padding: "10px"
		},
		children: "⚠️ Chat is currently offline. Please try again later."
	}) };
}));
var SafeChatLoader = () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Suspense, {
	fallback: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "Connecting to Chat..." }),
	children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RemoteChat, {})
});
...
function App() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "MFE Dashboard Shell" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: ["Status: ", isChatEnabled ? "✅ Features Active" : "❌ Features Disabled"] }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				onClick: () => setIsChatEnabled(!isChatEnabled),
				children: "Toggle Chat Flag"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("hr", {}),
			isChatEnabled ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				style: { marginTop: "20px" },
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SafeChatLoader, {})
			}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Chat is disabled by the Administrator." })
		]
	});
}
